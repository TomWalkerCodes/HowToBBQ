...
namespace HowToBBQ
{
    ...
    {
        #region NavigationHelper registration and other crap that is needed.
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter == null)
            {
                (this.DataContext as RecipeViewModel).Recipe = new BBQRecipe();
            ...
            else
            {
                ...
                (this.DataContext as RecipeViewModel).Recipe = e.Parameter as BBQRecipe;
            }
            ///**********************************
            //Added - end
            ///**********************************
